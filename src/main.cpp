...
uint256 hashGenesisBlock("0x68476bb87dc461481e4ec7bb486120ac678e5061cd7b4773720591683204c385");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 525600); // Trumpcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Trumpcoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Trumpcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xac412a7711670454c5a5709eb995b92104e62615c0c4e07c0bb2c00aa9ee6928");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "12/28/2024 - Donald J. Trump 47th president of the United States.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 100 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04d83c6a53c3fa6d6c0a16c14d056d052adee9a711dc9c0ce8ff70950084dd27af287bf6286e923581c5a7b76a12e63e958b9565931ebfe9e92ee54adeee67c9ac") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1735404493;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1735404493;

        if (fTestNet)
        {
            block.nTime    = 1735404444;
            block.nNonce   = 386069083;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x12a765e31ffd4059bada1e25190f6e98c99d9714d334efa41a195a7e7e04bfe2"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc3, 0xb9, 0xdf }; // Trumpcoin: increase each by adding 2 to bitcoin's value.
